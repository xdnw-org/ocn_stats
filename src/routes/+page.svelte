    ...
    <div class="row">
      <div class="col-sm-6 d-flex align-items-center">
        <div class="card mx-auto" style="width: 18rem;">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqidXxyUAKKGxZfnYC2q1FUVKXWUaLSVCWRArWqHPsKQ&s" class="card-img-top" alt="...">
      ...
      <div class="col-sm-6 d-flex align-items-center">
        <div class="card mx-auto" style="width: 18rem;">
          <img src="favicon-large.webp" style="background:#E4A020" class="card-img-top" alt="...">
          ...
          <div class="card-body" style="height: 9rem;">
            ...
            <p class="card-text">Get breaking news about ongoing conflicts and share in their discussions. Available on Orbis Crowned News discord server.</p>
          </div>
          <div class="card-footer">
            <a href="https://discord.gg/rnVNEWNKQb" class="btn btn-lg btn-secondary btn-outline-info border-3">Join Now!</a>
          </div>
        </div>
      </div>
    </div>
